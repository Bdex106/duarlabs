export const copy = {
  es: {
    nav: {
      ...
      contact: 'Contacto',
      items: [
        { label: 'Sobre', meta: 'Operación real', href: '/#about' },
        { label: 'IA y Datos', meta: 'Criterio útil', href: '/#presentation' },
        { label: 'Tecnologías', meta: 'Stack aplicado', href: '/#technology' },
        { label: 'Capacidades', meta: 'Ingeniería aplicada', href: '/#capabilities' },
        { label: 'Proyectos', meta: 'Casos visibles', href: '/#projects' },
        { label: 'Criterio', meta: 'Construcción técnica', href: '/#why' },
        { label: 'Rendimiento', meta: 'Confianza operativa', href: '/#performance' },
        { label: 'Metodología', meta: 'Ruta técnica', href: '/#methodology' },
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Presencia digital con identidad sobria para una organizacion.',
  ...
  en: {
    nav: {
      ...
      contact: 'Contact',
      items: [
        { label: 'About', meta: 'Real operations', href: '/#about' },
        { label: 'AI & Data', meta: 'Useful judgment', href: '/#presentation' },
        { label: 'Technology', meta: 'Applied stack', href: '/#technology' },
        { label: 'Capabilities', meta: 'Applied engineering', href: '/#capabilities' },
        { label: 'Projects', meta: 'Visible work', href: '/#projects' },
        { label: 'Judgment', meta: 'Technical judgment', href: '/#why' },
        { label: 'Performance', meta: 'Operational trust', href: '/#performance' },
        { label: 'Methodology', meta: 'Technical path', href: '/#methodology' },
